...
st.markdown('<p class="main-title">🚚 Real-Time Delivery Time Prediction System</p>', unsafe_allow_html=True)
...
# =========================================================
# 📍 Address Input & Map Visualization
# =========================================================
...
if restaurant_address and delivery_address:
    ...
    if rest_lat and del_lat:
        ...
        # =========================================================
        st.info("🔄 Real-time predictions updating every 5 seconds...")
        ...
        for i in range(100):
            try:
                ...
                with placeholder.container():
                    ...
                    st.progress(min(100, int((i+1)/100 * 100)))
                time.sleep(5)
            except Exception as e:
                st.error(f"⚠️ Prediction error: {e}")
                break
    else:
        st.warning("⚠️ Could not geolocate one or both addresses. Try adjusting or rephrasing them.")
else:
    st.info("ℹ️ Please enter both restaurant and delivery addresses to view map and prediction.")
